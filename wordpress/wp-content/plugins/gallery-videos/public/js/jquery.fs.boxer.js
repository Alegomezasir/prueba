; (function ($, window) {
	...
	function preloadGallery(e) {
		...
		if (data.gallery.index > 0) {
			...
			if (source.indexOf("youtube.com") < 0 && source.indexOf("vimeo.com/video") < 0 || source.indexOf("wistia") < 0) {
				$('<img src="' + source + '">');
			}
		}
				...
				function (e) {
					...
					if ($(e.target).is(data.$container)) {
						...
						var source = data.$target.attr("href"),
							isVideo = (source.indexOf("youtube.com") > -1 || source.indexOf("vimeo.com/video") > -1 || source.indexOf("wistia") > -1 || source.indexOf(".mp4") > -1),
