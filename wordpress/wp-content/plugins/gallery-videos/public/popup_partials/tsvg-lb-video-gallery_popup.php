<style type="text/css">
    ...
    .tsvg_pp_pic_holder<?php echo esc_attr( $tsvg_shortcode_id ); ?>::-webkit-scrollbar {
        display: none;
    }
...
<script type="text/javascript">
    let tsvgLightboxCreate<?php echo esc_attr( $tsvg_js_shortcode_id ); ?> = function () {
                ...
                $.fn.prettyPhoto<?php echo esc_attr( $tsvg_shortcode_id ); ?> = function (tsvg_pp_settings) {
                    ...
                    function tsvg_center_overlay<?php echo esc_attr( $tsvg_shortcode_id ); ?>() {
                        if (doresize && typeof $tsvg_pp_pic_holder<?php echo esc_attr( $tsvg_shortcode_id ); ?> != 'undefined') {
                            var width = $tsvg_pp_pic_holder<?php echo esc_attr( $tsvg_shortcode_id ); ?>.width(),
                                height = $tsvg_pp_pic_holder<?php echo esc_attr( $tsvg_shortcode_id ); ?>.height();
                                _getDimensions<?php echo esc_attr( $tsvg_shortcode_id ); ?>(width, height);
